...
- Install package with uv (`uv sync`)
...
- To run the experiment, use `uv run run --config_path <path-to-config> --exp_folder <folder-to-store-the-experiment>`. [CLI definition](https://github.com/oldhroft/kp_regression/blob/main/kp_regression/run_experiment.py#L27)
